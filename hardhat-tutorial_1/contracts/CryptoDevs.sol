...
contract CryptoDevs is ERC721Enumerable, Ownable {
    ...
    */
    function startPresale() public onlyOwner {
        ...
        presaleEnded = block.timestamp + 5 minutes; //??? lol
    }
    ...
    function presaleMint() public payable onlyWhenNotPaused {
        ...
        _safeMint(msg.sender, tokenIds); //??? where is safeMint coming from?
    }
    ...
    */
    function withdraw() public onlyOwner {
        address _owner = owner(); //??? where is owner() coming from?
        uint256 amount = address(this).balance;
        (bool sent, ) = _owner.call{value: amount}(""); //??? wtf is happening here?
